...
/*
 * added by Hu Chunxu (huchunxu@hust.edu.cn)
 */
...
//#define  DEF_INT_CPU_NBR_BITS                           (INT32U * DEF_OCTET_NBR_BITS)
//#define  DEF_INT_32U_MAX_VAL                      4294967295uL
//#define  DEF_BIT_FIELD(bit_field, bit_shift)         ((((bit_field) >= DEF_INT_CPU_NBR_BITS) ? (DEF_INT_32U_MAX_VAL)
