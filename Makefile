...
EXTRAINCDIRS = include $(DIR_SRC) $(DIR_TARGET) 
...
CFLAGS = -g$(DEBUG) $(CDEFS) $(CINCS) $(OPT) $(patsubst %,-I%,$(EXTRAINCDIRS))
CFLAGS += -Wall -Wimplicit -Wpointer-arith -Wswitch -Wshadow -Wunused
CFLAGS += -ffunction-sections -fdata-sections -Wredundant-decls -Wreturn-type
...
LDFLAGS += $(NEWLIBLPC) $(MATH_LIB) $(CPLUSPLUS_LIB)
LDFLAGS += -lc -lgcc 
LDFLAGS += $(patsubst %,-L%,$(EXTRA_LIBDIRS))
LDFLAGS += $(patsubst %,-l%,$(EXTRA_LIBS))

# Set Linker-Script Depending On Selected Memory and Controller
LDFLAGS +=-Ttarget/$(SUBMDL)_RAM.ld
